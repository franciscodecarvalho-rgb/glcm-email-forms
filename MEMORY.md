...
### 2026-09 — Cadastro de Temas

**Regra confirmada:** O GLCM possui cadastro de Temas com nome, descrição opcional, situação ativo/inativo, autoria e datas, acessível na rota protegida `/Temas` pelo botão Temas do cabeçalho.
**Origem:** Autorização de Nodley para a etapa de MVP do cadastro de Temas.
