...
describe("seleção de modelos por tipo de ação", () => {
  it.each([
    ...
    ["contribuicao_extraordinaria", "tributaria", "peticao_contribuicao_extraordinaria", "contrato_tributario"],
    ...
    ["supressao_folgas", "trabalhista", "peticao_supressao_folgas", "contrato_trabalhista"],
